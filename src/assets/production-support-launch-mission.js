(function(root){
  ...
  AhaFrame.registerMission({
    ...
    evidence:[
      ...
      {id:'architecture-stack',source:'derived',path:'labels'},
      {id:'subsystem-evidence',source:'derived',path:'tradeoffs'},
      {id:'evaluation-evidence',source:'derived',path:'evaluation'},
    ],
    interventions:[
