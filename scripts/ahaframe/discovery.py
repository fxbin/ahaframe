...
def build():
    ...
    urls=['/en/','/en/lessons/token-playground/','/en/lessons/context-window/','/en/lessons/agent-loop/','/en/labs/rag-failure/','/en/labs/agent-reliability/','/en/pricing/','/en/early-access/']
