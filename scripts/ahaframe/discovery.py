...
def build():
    ...
    urls=['/en/','/en/lessons/token-playground/','/en/lessons/context-window/','/en/lessons/agent-loop/','/en/labs/rag-failure/','/en/labs/agent-reliability/','/en/labs/evaluation-failure/','/en/labs/context-compression/','/en/labs/instruction-conflict/','/en/labs/agent-workflow-graph/','/en/pricing/','/en/early-access/']
