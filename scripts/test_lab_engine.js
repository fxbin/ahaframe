...
assert.deepEqual(
  ...
  ['token-playground','context-window','agent-loop'],
  'expected the three MVP scenarios to be registered',
);
...
console.log('PASS Lab Engine: registry, deterministic scenarios, history, checkpoints, compare, replay, reset, validation.');
