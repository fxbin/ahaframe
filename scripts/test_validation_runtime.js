...
(async()=>{
  ...
  location.search='?intent=foundations-39';
  document.documentElement.lang='en';
  global.AHAFRAME_CONFIG.waitlistEndpoint='';
  const waitlistPayload=AhaFrame.buildWaitlistPayload(' Test@Example.com ','foundations-39');
  assert.equal(waitlistPayload.email,'test@example.com');
  assert.equal(waitlistPayload.intent,'foundations-39');
  ...
  const demoWaitlist=await AhaFrame.submitWaitlist(' Test@Example.com ','foundations-39');
